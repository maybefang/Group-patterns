...
#     tiny_train = TinyImageNet('./tiny-imagenet-200', split='train')
...
#     tiny_train = TinyImageNet('./tiny-imagenet-200', split='val')
#     print(tiny_train.__getitem__(99))

#     # in-memory test
#     tiny_val = TinyImageNet('tiny-imagenet-200', split='val', in_memory=True)
#     print(len(tiny_val))
#     print('over')